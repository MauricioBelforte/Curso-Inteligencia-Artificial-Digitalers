...
a. Asignar la restricción UNSIGNED al campo
Monto, manteniendo el tipo de dato ya
definido para el campo.

2. Modificar la tabla ARTICULOS tomando
en cuenta las siguientes consideraciones:

a. Cambiar el tipo de dato del campo Nombre
para que admita hasta 75 caracteres.

b. Asignar las restricciones UNSIGNED y
...
b. Cambiar el tipo de dato del campo
Apellido para que admita hasta 35
caracteres y asigne la restricción
correspondiente para que su carga
sea obligatoria.

c. Cambiar el nombre del campo
Comentarios por Observaciones y su
tipo de dato para que admita hasta
255 caracteres.

4. Crear un PROMPT para que la IA
modifique el código que venimos
desarrollando, de tal forma que se
relacionen las tablas CLIENTES y
LOCALIDAD.


5. Copiar y ejecutar el código generado
por la IA para que se reflejen los
cambios en la base de datos.

*/


-- Los alias l."Nombre" y l."Provincia"  están entre comillas porque las columnas usan mayúsculas.
...
ALTER TABLE "Clientes" ALTER COLUMN "observaciones" TYPE varchar(255);
 */
...
/* 2.c
ALTER TABLE "Articulos" ALTER COLUMN "stock" SET NOT NULL;
-- ALTER TABLE "Articulos" ALTER COLUMN "stock" SET UNSIGNED; UNSIGNED NO EXISTE EN POSTGRES
 */
/* 2.b
ALTER TABLE "Articulos" ALTER COLUMN "precio" SET NOT NULL;
-- ALTER TABLE "Articulos" ALTER COLUMN "precio" SET UNSIGNED; UNSIGNED NO EXISTE EN POSTGRES
 */
...
/* 1.a UNSIGNED NO EXISTE EN POSTGRES
ALTER TABLE "Facturas" ADD UNSIGNED(Monto)
*/
